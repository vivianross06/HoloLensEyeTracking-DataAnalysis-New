...
average_session1_error_data <- read.csv("/Users/vivianross/Documents/School/Research/EyeTracking/HoloLensEyeTracking-DataAnalysis-New/Data/session1_recalibrated_calibration_average_error.csv", header = TRUE, fileEncoding = 'UTF-8-BOM')
#average errors: session 2 recalibrated with calibration task
average_session2_error_data <- read.csv("/Users/vivianross/Documents/School/Research/EyeTracking/HoloLensEyeTracking-DataAnalysis-New/Data/session2_recalibrated_calibration_average_error.csv", header = TRUE, fileEncoding = 'UTF-8-BOM')
...
DescTools::PostHocTest(result, NULL, "bonferroni", 0.95)

#hololens
m_total_session <- art(data = total_session_error, cosineError ~ taskname * trial * hololens + Error(id))
result <- anova(m_total_session)
result
...
#average errors: moving recalibrated with wsBodyConstrained task
